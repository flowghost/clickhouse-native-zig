...
Важно: это только wire-level форма callback. Для реального логина callback должен возвращать настоящую SSH signature.

### `live_verify.zig`

Полный end-to-end прогон против живого ClickHouse:
